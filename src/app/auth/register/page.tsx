...
import { Mail, Lock, Eye, EyeOff, Phone, ArrowRight, Sparkles, CheckCircle } from "lucide-react";
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await register(email, password, telefone);
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="bg-[#D4AF37]/10 border border-[#D4AF37]/30 rounded-xl p-4 space-y-2">
              <div className="flex items-center gap-2 text-sm text-gray-300">
                ...
                <span>Acesso gratuito a cursos básicos</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-gray-300">
                <CheckCircle className="w-4 h-4 text-[#D4AF37]" />
                <span>Sistema de gamificação e medalhas</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-gray-300">
                <CheckCircle className="w-4 h-4 text-[#D4AF37]" />
